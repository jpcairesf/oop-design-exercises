...
class TestBank(unittest.TestCase):
    ...
    def test_create_account(self):
        ...
        self.assertEqual(100, self.bank.accounts[1].balance)

    def test_create_account_error_already_exists(self):
        self.bank.create_account(1, 100)
        with self.assertRaises(ValueError):
            self.bank.create_account(1, 150)

    def test_create_account_error_invalid_number(self):
        with self.assertRaises(ValueError):
            self.bank.create_account(0, 100)

    def test_create_account_error_invalid_amount(self):
        with self.assertRaises(ValueError):
            self.bank.create_account(1, -100)
    ...
    def test_deposit(self):
        ...
        self.assertIn(1, self.bank.transactions)
        self.assertEqual(self.bank.accounts[1].balance, 150)

    def test_deposit_error_invalid_amount(self):
        self.bank.create_account(1, 100)
        with self.assertRaises(ValueError):
            self.bank.deposit(1, 0, date.today())

    def test_deposit_error_invalid_date(self):
        self.bank.create_account(1, 100)
        with self.assertRaises(ValueError):
    ...
    def test_withdraw_error_invalid_amount(self):
        self.bank.create_account(1, 100)
        with self.assertRaises(ValueError):
            self.bank.withdraw(1, -50, date.today())

    def test_withdraw_error_insufficient_funds(self):
        self.bank.create_account(1, 100)
        with self.assertRaises(ValueError):
            self.bank.withdraw(1, 150, date.today())

    def test_withdraw_error_invalid_date(self):
        self.bank.create_account(1, 100)
        with self.assertRaises(ValueError):
    ...
    def test_transfer_error_invalid_amount(self):
        self.bank.create_account(1, 100)
        self.bank.create_account(2, 100)
        with self.assertRaises(ValueError):
    ...
    def test_generate_report_error_invalid_account(self):
        with self.assertRaises(ValueError):
            self.bank.generate_report(1, date.today(), date.today())

    def test_generate_report_error_invalid_date_range(self):
        self.bank.create_account(1, 100)
        with self.assertRaises(ValueError):
